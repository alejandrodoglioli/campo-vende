...
var cmThemeDefaultBase = '/admin/js/';
var cmThemeImages = '/admin/images/';
...
var cmThemeDefault = 
{
	...
	folderLeft: '<img alt="" src="' + cmThemeImages + 'spacer.png">',
	// 1, HTML code to the right of the folder item
	folderRight: '<img alt="" src="' + cmThemeImages + 'arrow.png">',
	// 2, HTML code to the left of the regular item
	itemLeft: '<img alt="" src="' + cmThemeImages + 'spacer.png">',
	// 3, HTML code to the right of the regular item
	itemRight: '<img alt="" src="' + cmThemeImages + 'blank.png">',
