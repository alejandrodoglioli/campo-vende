...
function setearVariablesComunes(&$t){
	...
	if(isset($_SESSION[nombre_user_sistema])){
		...
		$t->set_var("link_login_salir",'<a href="/es/login.htm" title="Mi Cuenta">Mi Cuenta</a> | <a href="/es/logout_productoxusuario" title="Salir">Salir</a>');
	}else{
		$t->set_var("usuario_logueado", "");
		$t->set_var("link_login_salir",'<a href="/es/login.htm" title="Login / Registrarse">Login / Registrarse</a>');
	}
