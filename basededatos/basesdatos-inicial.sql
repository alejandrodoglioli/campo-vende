...
insert  into `configuracion`(`nombre_empresa`,`dueno_empresa`,`direccion_empresa`,`telefono_empresa`,`fax_empresa`,`mail_empresa`,`id`,`slogan`) values ('e-DirectorioEmpresas.com','Alejandro Doglioli','','','','ferriesa@gmail.com',0,'La más completa guía de empresas en Espana.');
...
insert  into `secciones`(`id`,`id_padre`,`id_tiposeccion`,`publicado`,`menu_lateral`,`orden`,`fecha_publicacion`) values (1,0,0,1,NULL,1,'2011-06-10');
...
insert  into `seccionesxidioma`(`id`,`idioma`,`contenido`,`nombre`,`description`,`keywords`,`title`) values (1,'es','Martin comilon!!','Home',NULL,NULL,NULL);
