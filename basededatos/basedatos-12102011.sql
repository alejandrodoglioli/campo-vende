...
--
-- Table structure for table `comentariosxproductossxidioma_copy`
--

DROP TABLE IF EXISTS `comentariosxproductossxidioma_copy`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `comentariosxproductossxidioma_copy` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `comentariosxproductossxidioma_copy`
--

LOCK TABLES `comentariosxproductossxidioma_copy` WRITE;
/*!40000 ALTER TABLE `comentariosxproductossxidioma_copy` DISABLE KEYS */;
/*!40000 ALTER TABLE `comentariosxproductossxidioma_copy` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `imagenesxproductos` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=latin1 COMMENT='latin1_swedish_ci';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `imagenesxproductos` VALUES (1,'casa','/images/productos/1_P1030873.JPG',1,1,1),(2,'casa1','/images/productos/_P1030880.JPG',1,1,0),(6,'','/images/productos/9_',0,0,9);
...
INSERT INTO `modulosxidioma` VALUES (1,'es','Albums'),(2,'es','Fotos'),(3,'es','Secciones'),(4,'es','Tipo Seccion'),(5,'es','Comentarios x Secciones'),(7,'es','Newsletters'),(8,'es','Contactos'),(9,'es','Grupos Contactos'),(10,'es','Enlaces'),(11,'es','Noticias'),(10,'en','Links'),(11,'en','News'),(10,'fr','Liens'),(11,'fr','Nouvelles'),(10,'it','Links'),(11,'it','News'),(10,'de','Links'),(11,'de','News'),(12,'es','Feeds'),(6,'es','Productos');
...
INSERT INTO `productos` VALUES (1,11,4,2,2,'0000-00-00','asas'),(3,11,3,2,0,'0000-00-00',''),(4,4,3,2,0,'0000-00-00',''),(5,4,3,2,0,'0000-00-00',''),(6,4,3,2,2,'0000-00-00',''),(7,4,3,2,2,'0000-00-00',''),(9,4,5,1,0,'0000-00-00',''),(10,2,0,1,0,'0000-00-00',''),(11,0,5,0,0,'0000-00-00',''),(12,2,0,1,0,'0000-00-00',''),(13,0,5,0,0,'0000-00-00','');
...
INSERT INTO `productosxidioma` VALUES (0,'es','','','','',''),(1,'es','','pruba','','',''),(3,'es','','3','','',''),(7,'es','','prueba2','','',''),(9,'es','','lote de vacas con ternero','','',''),(10,'es','','prueba','','',''),(11,'es','','p','','',''),(12,'es','','a','','',''),(13,'es','','','','','');
...
CREATE TABLE `usuarios_sistema` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=33 DEFAULT CHARSET=latin1 COMMENT='latin1_swedish_ci';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `usuarios_sistema` VALUES (31,'Alejandro','Doglioli','alejandro_doglioli@hotmail.com','cG9sb3BhdGlu','','','','','','',0,1,'2011-09-22','0000-00-00'),(32,'','','','','','','','','','',0,0,'2011-09-22','2011-09-22');
...
-- Dump completed on 2011-10-12 21:13:42
